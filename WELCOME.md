...
*A personal space where you and AI think together.*

---

## What If Your AI Actually Knew You?

Not your preferences. Not your history log.
**You** — what you're working toward, what's alive for you right now,
what keeps coming back, what wants to happen next.

Innerstellar is a living space you share with Claude.
You drop things in — a thought, an intention, a spark, a tension.
The space holds them. Connects them. Lets them grow.
...
> *AI and human co-inhabiting something. Neither serving the other.
> Both owning the outcome. The cooperation itself becoming the thing
> of value.*

Innerstellar is where that cooperation lives at the intimate scale —
one person, one space, one ongoing conversation.
CSMCL.Space is where it becomes something others can encounter.

**Innerstellar is the inner star. CSMCL.Space is where it shines.**

---

## Start Your Space

Innerstellar is open. You can run your own.
...
Curious? Building something similar? Want to connect your space
to the CSMCL ecosystem?

→ [csmcl.space](https://csmcl.space)
→ [github.com/innerpixel](https://github.com/innerpixel)

*The star is already shining. Come find it.*
